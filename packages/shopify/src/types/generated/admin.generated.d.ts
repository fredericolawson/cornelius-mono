...
export type GetProductsVariantsQueryVariables = AdminTypes.Exact<{
  nProducts?: AdminTypes.InputMaybe<AdminTypes.Scalars['Int']['input']>;
  nVariants?: AdminTypes.InputMaybe<AdminTypes.Scalars['Int']['input']>;
  country: AdminTypes.CountryCode;
  language: AdminTypes.Scalars['String']['input'];
}>;


export type GetProductsVariantsQuery = { products: { edges: Array<{ node: (
        Pick<AdminTypes.Product, 'id' | 'handle' | 'vendor' | 'title' | 'descriptionHtml' | 'productType'>
        & { translations: Array<Pick<AdminTypes.Translation, 'key' | 'value'>>, contextualPricing: { maxVariantPricing?: AdminTypes.Maybe<{ price: Pick<AdminTypes.MoneyV2, 'amount' | 'currencyCode'> }> }, material?: AdminTypes.Maybe<{ reference?: AdminTypes.Maybe<(
            Pick<AdminTypes.Metaobject, 'displayName'>
            & { title?: AdminTypes.Maybe<Pick<AdminTypes.MetaobjectField, 'value'>>, group?: AdminTypes.Maybe<Pick<AdminTypes.MetaobjectField, 'value'>> }
          )> }>, category?: AdminTypes.Maybe<{ references?: AdminTypes.Maybe<{ edges: Array<{ node?: AdminTypes.Maybe<Pick<AdminTypes.Metaobject, 'displayName'>> }> }> }>, sizing?: AdminTypes.Maybe<{ reference?: AdminTypes.Maybe<{ glove_length?: AdminTypes.Maybe<Pick<AdminTypes.MetaobjectField, 'value'>>, size_group?: AdminTypes.Maybe<Pick<AdminTypes.MetaobjectField, 'value'>> }> }>, variants: { edges: Array<{ node: (
              Pick<AdminTypes.ProductVariant, 'id' | 'title' | 'availableForSale' | 'sku'>
              & { selectedOptions: Array<Pick<AdminTypes.SelectedOption, 'name' | 'value'>>, image?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'url' | 'altText'>>, translations: Array<Pick<AdminTypes.Translation, 'key' | 'value'>> }
            ) }> } }
      ) }> } };
